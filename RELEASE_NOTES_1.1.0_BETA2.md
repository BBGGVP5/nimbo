...
- Форма и вид облака теперь выбираются по живым миниатюрам — сразу видно будущий результат, без непонятных текстовых переключателей.
- Для фона появилась полноценная палитра: можно подобрать любой оттенок, а не только один из готовых цветов.
- Для уведомлений и отдельного ярлыка по-прежнему можно загрузить собственное изображение.
